  ...
  return (
    <div className="app">
      <nav className="nav">
        ...
        <span className="badge" style={{ background: 'rgba(99,102,241,0.2)', marginLeft: 'auto' }}>
        ...
        <a href="http://localhost:3001/swagger-ui/index.html" target="_blank" rel="noreferrer" style={{ padding: '0.35rem 0.75rem', textDecoration: 'none', color: 'var(--text-muted)' }}>{t('swagger', lang)} ↗</a>
      ...
      <div className="layout">
        <aside className="sidebar">
          ...
          <NavLink to="/data">{t('nav.importHub', lang)}</NavLink>
          <NavLink to="/catalog">{t('nav.catalog', lang)}</NavLink>
          <a href="http://localhost:3001/swagger-ui/index.html" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>{t('swagger', lang)} ↗</a>
          <NavLink to="/settings">{t('nav.settings', lang)}</NavLink>
          <NavLink to="/profile">{t('nav.customerProfile', lang)}</NavLink>
        </aside>
        <main className="main">
